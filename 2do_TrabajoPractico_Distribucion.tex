...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a11}\label{a11}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a12}\label{a12}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a13}\label{a13}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a14}\label{a14}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a15}\label{a15}}
...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a21}\label{a21}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a22}\label{a22}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a23}\label{a23}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a24}\label{a24}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a25}\label{a25}}
	\caption{(a) Ventana principal para 300MHz, espaciado de $\lambda / 2$ y coeficientes homogeneos. (b) Ventana de edición para ingresar las fuentes homogeneas de acuerdo a los coeficientes. (c) Plano vertical con patrón de radiación. (d) Vista en 3D del patrón de radiación. (e)SWR y coeficiente de refleción.}
\end{figure}
...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a31}\label{a31}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a32}\label{a32}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a33}\label{a33}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a34}\label{a34}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a35}\label{a35}}
	\caption{(a) Ventana principal para 300MHz, espaciado de $\lambda / 2$ y coeficientes homogeneos. (b) Ventana de edición para ingresar las fuentes homogeneas de acuerdo a los coeficientes. (c) Plano vertical con patrón de radiación. (d) Vista en 3D del patrón de radiación. (e)SWR y coeficiente de refleción.}
\end{figure}
\newpage
...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a41}\label{a41}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a42}\label{a42}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a43}\label{a43}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a44}\label{a44}}
	\subfloat[]{
...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a51}\label{a51}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a52}\label{a52}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a53}\label{a53}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a54}\label{a54}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a55}\label{a55}}
	\caption{(a) Ventana principal para 300MHz, espaciado de $\lambda / 4$ y coeficientes homogeneos. (b) Ventana de edición para ingresar las fuentes homogeneas de acuerdo a los coeficientes. (c) Plano vertical con patrón de radiación. (d) Vista en 3D del patrón de radiación. (e)SWR y coeficiente de refleción.}
\end{figure}
...
\begin{figure}[h]
	\centering
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a61}\label{a61}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a62}\label{a62}}	
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a63}\label{a63}} \\
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a64}\label{a64}}
	\subfloat[]{
		\includegraphics[scale=0.35]{IMAGENES/a65}\label{a65}}
	\caption{(a) Ventana principal para 300MHz, espaciado de $\lambda / 4$ y coeficientes homogeneos. (b) Ventana de edición para ingresar las fuentes homogeneas de acuerdo a los coeficientes. (c) Plano vertical con patrón de radiación. (d) Vista en 3D del patrón de radiación. (e)SWR y coeficiente de refleción.}
\end{figure}
